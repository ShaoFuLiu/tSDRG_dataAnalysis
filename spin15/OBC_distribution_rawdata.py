...
for j in range(len(Jdis)):
    ...
    for i in range(len(Ls)):
        ...
        for i in range(len(arr)):
            num = arr[i] 
            myfile = '/home/liusf/tSDRG/Main15/data/'+ BC +'/'+ delta +'/L'+ str(L) +'_P10_m'+ str(m) +'_'+ num + '/L'+ str(L) +'_P10_m'+ str(m) +'_'+ num +'_corr1.csv'
        ...
        direc = '/home/liusf/test/spin15/Distribution_end_to_end_correlation'
