...
print('n = 2, Lambda0 = '+ str(Lambda0_n2[0]))
print('n = 2, Lambda1 = '+ str(Lambda1_n2[0]))
...
print('n = 4, Lambda0 = '+ str(Lambda0_n4[0]))
print('n = 4, Lambda1 = '+ str(Lambda1_n4[0]))
"""
# plot the function 
...
plt.legend(loc = 'best')
plt.savefig('SMHW5-2.pdf', format='pdf', dpi=4000)
plt.show()"""