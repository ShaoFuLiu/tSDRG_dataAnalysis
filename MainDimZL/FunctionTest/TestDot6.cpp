...
int main()
{
    ...
    for(int i=0;i<3;i++)
    {
        ...
        S[i*N+0] =  uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(s, Id), Id), Id), Id), Id);
        S[i*N+1] =  uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(Id, s), Id), Id), Id), Id);
        S[i*N+2] =  uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(Id, Id), s), Id), Id), Id);
        S[i*N+3] =  uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(Id, Id), Id), s), Id), Id);
        S[i*N+4] =  uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(uni10::Otimes(Id, Id), Id), Id), s), Id);
