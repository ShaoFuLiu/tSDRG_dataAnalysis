...
for i in range(len(Ls)):
    ...
    for m in range(len(chis)):
        ...
        for j in range(len(Jdis)):
            ...
            M = chis[m]
            myfile = '/home/liusf/tSDRG_DataAnalysis/Sorting_data/Spin'+ str(int(spin)) +'/metadata/SOP/'+ jdis + '/Dimer-Oz/'+ BC +'_L'+ str(L) +'_P' + str(P) + '_m'+ str(M) +'_dim-sop_AV'+ str(N) +'.csv'
...
#plt.xscale('log')
#plt.yscale('log')
plt.title(r'$\chi$ = %d'%(M), fontsize=12)
